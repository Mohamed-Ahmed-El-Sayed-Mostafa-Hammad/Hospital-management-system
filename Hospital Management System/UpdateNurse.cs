...
namespace Hospital_Management_System
{
    public partial class UpdateNurse : Form
    {
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("select * from Nurse where name = '" + textBox4.Text + "'", con);
        ...
        private void Add_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string str = " UPDATE Nurse SET name = '" + nameBox.Text + "', age ='" + AgeBox.Text + "' , date ='" + dateTimePicker1.Text + "' , address ='" + AddressBox.Text + "', shiftHours ='" + textBox3.Text + "', contact ='" + ContactBox.Text + "', section ='" + textBox1.Text + "', salary ='" + textBox2.Text + "' WHERE name = '" + textBox4.Text + "'";
                ...
                if (dr.Read())
                {
                    MessageBox.Show("Nurse Information Updated Successfully..");
                }
            }
